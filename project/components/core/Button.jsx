...
export function Button({ variant = "primary", size = "md", children, icon, disabled, onClick, style }) {
  const [h, fs, px] = { sm: [38, 11, 18], md: [48, 12, 26], lg: [58, 13, 34] }[size] || [48, 12, 26];
  const variants = {
  ...
  return (
    <button
      ...
      style={{
        ...
        height: h, padding: `0 ${px}px`, fontFamily: "var(--font-sans)",
        fontSize: fs, fontWeight: "var(--weight-semibold)", letterSpacing: "var(--tracking-caps)",
