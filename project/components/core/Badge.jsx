...
export function Badge({ tone = "fog", children, style }) {
  const tones = {
  ...
  return (
    <span style={{
      ...
      fontFamily: "var(--font-sans)", fontSize: 10, fontWeight: "var(--weight-semibold)",
      letterSpacing: "0.28em", textTransform: "uppercase",
      border: "1px solid", borderRadius: "2px 10px 2px 2px",
      ...tones[tone], ...style,
    }}>
      {children}
    </span>
