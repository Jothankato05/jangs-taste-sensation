...
export function Switch({ label, checked, onChange, style }: SwitchProps) {
  return (
    <label onClick={() => onChange?.(!checked)} style={{ display: "inline-flex", alignItems: "center", gap: 12, cursor: "pointer", fontFamily: "var(--font-sans)", ...style }}>
      <span
        style={{
          width: 44,
          height: 24,
