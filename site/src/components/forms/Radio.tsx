...
export function Radio({ label, checked, onChange, style }: RadioProps) {
  return (
    <label onClick={() => onChange?.(true)} style={{ display: "inline-flex", alignItems: "center", gap: 12, cursor: "pointer", fontFamily: "var(--font-sans)", ...style }}>
      <span
        style={{
          width: 20,
          height: 20,
