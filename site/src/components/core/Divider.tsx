...
export function Divider({ label, accent, style }: DividerProps) {
  const line: CSSProperties = { flex: 1, height: 1, background: accent ? "rgba(204,188,163,0.45)" : "var(--border-subtle)" };
